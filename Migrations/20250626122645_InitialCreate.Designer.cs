...
namespace WebShopApp.Migrations
{
    ...
    [Migration("20250626122645_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebShopApp.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebShopApp.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebShopApp.Models.Cart", b =>
                {
                    b.HasOne("WebShopApp.Models.ApplicationUser", "User")
                        .WithMany("Carts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
